...
export default function CreateCourseModal({ isOpen, onClose, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("Failed to create course - FULL ERROR:", err);
            if (err.response && err.response.data) {
                ...
                setError("Failed to create course. Please check your connection.");
            }
        } finally {
            setLoading(false);
        }
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl relative animate-in fade-in zoom-in duration-200 overflow-hidden">
                ...
                <div className="p-8">
                    <h2 className="text-2xl font-bold text-slate-800 mb-1">Create Course</h2>
                    <p className="text-slate-500 text-sm mb-6 font-medium">Enter the details for your new course.</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-800 placeholder:text-slate-300 text-sm"
                            />
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-800 placeholder:text-slate-300 text-sm resize-none"
                            />
                        </div>
                            ...
                            >
                                {imagePreview ? (
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Upload Profile</span>
                                    </div>
                                )}
                                <input
                                    type="file"
